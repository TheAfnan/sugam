            ...
            <div className="pt-2 mt-2 border-t border-slate-800/60">
              ...
              {isAuthenticated ? (
                ...
                <div className="space-y-1">
                  <Link
                    href="/login"
                    className="w-full flex items-center gap-3 px-3.5 py-2 rounded-xl text-xs font-medium text-slate-300 hover:bg-slate-800/60 hover:text-white transition-all text-left"
                  >
                  ...
                  <Link
                    href="/signup"
                    className="w-full flex items-center gap-3 px-3.5 py-2 rounded-xl text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 transition-all shadow-sm text-left"
                  >
